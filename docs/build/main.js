...
TourPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-tour',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/tour/tour.html"*/'<ion-header></ion-header>\n\n<ion-content city-bg>\n  <ion-slides pager>\n    <ion-slide>\n      <a class="skip-link" [navPush]="dashboardPage">\n        Skip\n      </a>\n      <div class="title">Welcome</div>\n      <div class="description">\n        IFA Connect is the easy way to earn cash-back from your Referrals\n      </div>\n    </ion-slide>\n\n    <ion-slide>\n      <a class="skip-link" [navPush]="dashboardPage">\n        Skip\n      </a>\n      <img src="assets/imgs/step-lead.png" />\n      <div class="title">Add a Referral</div>\n      <p class="description">Easily add a referral for your chosen service</p>\n    </ion-slide>\n\n    <ion-slide>\n      <a class="skip-link" [navPush]="dashboardPage">\n        Skip\n      </a>\n      <img src="assets/imgs/step-track.png" />\n      <div class="title">Track Referral Submissions</div>\n      <p class="description">\n        Review how your submitted Referrals are progressing, and which have\n        converted\n      </p>\n      <a\n        [navPush]="dashboardPage"\n        class="transparent-rounded-button"\n        style="margin-top: 2rem;"\n      >\n        done\n      </a>\n    </ion-slide>\n  </ion-slides>\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/tour/tour.html"*/,
    }),
...
TermsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-terms',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/terms/terms.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Terms of Service</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <div\n    class="mine"\n    [innerHTML]="tos | safeHtml"\n  ></div>\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/terms/terms.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
...
var GlobalStorage = (function () {
    function GlobalStorage() {
        ...
        this.primaryDomain = 'http://ifa.zweck.software:4000/';
...
ForgotPasswordThanksPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-forgot-password-thanks',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/forgotPasswordThanks/forgotPasswordThanks.html"*/'<ion-header></ion-header>\n\n<ion-content city-bg>\n  <div class="logo">\n    <img src="assets/imgs/catex-logo.png">\n    <p>The professional referral app</p>\n  </div>\n\n\n  <h4 class="title">We have just emailed you a password reset</h4>\n\n  <h5 class="text">Follow the link to reset your password and get back to adding referrals!</h5>\n\n  <a\n    (click)="goBack()"\n    class="transparent-rounded-button"\n  >\n    Back to Login\n  </a>\n\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/forgotPasswordThanks/forgotPasswordThanks.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
...
SettingsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-settings',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/settings/settings.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Settings</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <!--<small class="alert text-center mb3 bg-silver black rounded block" *ngIf="!connection.online">-->\n  <!--You are currently offline. For the best experience please connect to the internet. <a-->\n  <!--href="#/app/offline">More Information</a>-->\n  <!--</small>-->\n\n  <section [navPush]="profilePage">\n    <a>\n      <img [src]="current_user.profile_photo" />\n      <div class="name">\n        <div class="name">\n          {{ current_user.first_name }} {{ current_user.last_name }}\n        </div>\n        <div class="company">{{ current_user.company }}</div>\n      </div>\n    </a>\n  </section>\n\n  <section>\n    <ul>\n      <li [navPush]="profilePage">\n        <div *ngIf="!connection.online">\n          <div>\n            Edit Profile\n            <small>Unavailable offline</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Edit Profile\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n\n      <li [navPush]="paypalSettingsPage">\n        <div *ngIf="!connection.online">\n          <div>\n            Bank Account Settings\n            <small>Unavailable offline</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Bank Account Settings\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n\n      <li [navPush]="notificationsSettingsPage">\n        <div *ngIf="!connection.online">\n          <div>\n            Notifications Settings\n            <small>Notifications Settings</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Notifications Settings\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n\n      <li [navPush]="leadHistoryPage">\n        <div *ngIf="!connection.online">\n          <div>\n            Earnings History\n            <small></small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Earnings History\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n    </ul>\n  </section>\n\n  <section>\n    <ul>\n      <li [navPush]="faqPage">\n        <div *ngIf="!connection.online">\n          <div>\n            Frequently Asked Questions\n            <small>Unavailable offline</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Frequently Asked Questions\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n\n      <li [navPush]="termsPage">\n        <div *ngIf="!connection.online">\n          <div>\n            Terms &amp; Conditions\n            <small>Unavailable offline</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          Terms &amp; Conditions\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n\n      <li [navPush]="tourPage">\n        <div *ngIf="!connection.online">\n          <div>\n            About this App\n            <small>Notifications Settings</small>\n          </div>\n        </div>\n        <a *ngIf="connection.online">\n          About this App\n          <span class="fa fa-chevron-right"></span>\n        </a>\n      </li>\n    </ul>\n  </section>\n\n  <!-- Button (grey) -->\n  <button class="submit-button gray" (click)="logout()">\n    Log Out\n  </button>\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/settings/settings.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_2__services_globalstorage_globalstorage__["a" /* GlobalStorage */],
        __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* Http */],
...
LeadHistoryFiltersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-lead-history-filters',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/leadHistoryFilters/leadHistoryFilters.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Filter</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n\n  <form\n    (ngSubmit)="submit(form)"\n    novalidate\n    name="form.paypalForm"\n    id="paypal-form"\n    #form="ngForm"\n  >\n    <ion-list\n      radio-group\n      [(ngModel)]="status"\n      name="status"\n    >\n      <ion-item>\n        <ion-label>Display ALL</ion-label>\n        <ion-radio value="0"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Pending</ion-label>\n        <ion-radio value="1"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Won</ion-label>\n        <ion-radio value="2"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>Lost</ion-label>\n        <ion-radio value="3"></ion-radio>\n      </ion-item>\n    </ion-list>\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n      style="margin-top: 20px"\n    >\n      Update\n    </button>\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/leadHistoryFilters/leadHistoryFilters.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
...
WithdrawalHistoryFiltersPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-withdrawal-history-filters',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/withdrawalHistoryFilters/withdrawalHistoryFilters.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Select Date Range</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n\n  <form\n    (ngSubmit)="submit(form)"\n    novalidate\n    name="form.paypalForm"\n    id="paypal-form"\n    #form="ngForm"\n  >\n    <ion-list\n      radio-group\n      [(ngModel)]="date_range_id"\n      name="date_range_id"\n    >\n      <ion-item>\n        <ion-label>This Week</ion-label>\n        <ion-radio value="1"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>This Month</ion-label>\n        <ion-radio value="2"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>3 Months</ion-label>\n        <ion-radio value="4"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>This Year</ion-label>\n        <ion-radio value="3"></ion-radio>\n      </ion-item>\n      <ion-item>\n        <ion-label>ALL Time</ion-label>\n        <ion-radio value="5"></ion-radio>\n      </ion-item>\n    </ion-list>\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n      style="margin-top: 20px"\n    >\n      Update\n    </button>\n  </form>\n\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/withdrawalHistoryFilters/withdrawalHistoryFilters.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavParams */]])
...
ReferralDetailsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-referral-details',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/referralDetails/referralDetails.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Referral Details</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <form\n    (ngSubmit)="submit(form)"\n    novalidate\n    name="form.registerForm"\n    id="register-form"\n    #form="ngForm"\n  >\n    <div class="form-label">Basic info</div>\n\n    <ion-row>\n      <ion-col col-6 style="padding-left: 0;">\n        <input\n          type="text"\n          placeholder="Forename*"\n          [(ngModel)]="lead.first_name"\n          name="firstname"\n          required\n          [pattern]="onlyLettersRegEx"\n          #firstName="ngModel"\n        />\n        <div\n          role="alert"\n          [hidden]="\n            !(\n              firstName.invalid &&\n              (firstName.dirty || firstName.touched || submited)\n            )\n          "\n        >\n          <div [hidden]="!firstName.hasError(\'required\')" class="error">\n            Please enter a value.\n          </div>\n          <div [hidden]="!firstName.hasError(\'pattern\')" class="error">\n            Please enter letters only.\n          </div>\n        </div>\n      </ion-col>\n      <ion-col col-6 style="padding-right: 0;">\n        <input\n          type="text"\n          placeholder="Surname*"\n          [(ngModel)]="lead.last_name"\n          name="surname"\n          required\n          [pattern]="onlyLettersRegEx"\n          #surName="ngModel"\n        />\n        <div\n          role="alert"\n          [hidden]="\n            !(surName.invalid && (surName.dirty || surName.touched || submited))\n          "\n        >\n          <div [hidden]="!surName.hasError(\'required\')" class="error">\n            Please enter a value.\n          </div>\n          <div [hidden]="!surName.hasError(\'pattern\')" class="error">\n            Please enter letters only.\n          </div>\n        </div>\n      </ion-col>\n    </ion-row>\n\n    <input\n      type="text"\n      placeholder="Company Name"\n      [(ngModel)]="lead.company"\n      name="company"\n      #company="ngModel"\n    />\n\n    <input\n      type="text"\n      placeholder="Email Address*"\n      [(ngModel)]="lead.email_address"\n      name="email"\n      required\n      [pattern]="emailRegEx"\n      #email="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="!(email.invalid && (email.dirty || email.touched || submited))"\n    >\n      <div [hidden]="!email.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!email.hasError(\'pattern\')" class="error">\n        Please enter a valid email address.\n      </div>\n    </div>\n\n    <input\n      type="tel"\n      placeholder="Mobile Number*"\n      [(ngModel)]="lead.mobile_number"\n      name="mobile"\n      [pattern]="onlyNumbersRegEx"\n      required\n      #mobile="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="\n        !(mobile.invalid && (mobile.dirty || mobile.touched || submited))\n      "\n    >\n      <div [hidden]="!mobile.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!mobile.hasError(\'pattern\')" class="error">\n        Please enter a valid phone number.\n      </div>\n    </div>\n\n    <input\n      type="tel"\n      placeholder="Phone Number*"\n      [(ngModel)]="lead.phone_number"\n      name="phone"\n      required\n      [pattern]="onlyNumbersRegEx"\n      #phone="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="!(phone.invalid && (phone.dirty || phone.touched || submited))"\n    >\n      <div [hidden]="!phone.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!phone.hasError(\'pattern\')" class="error">\n        Please enter a valid phone number.\n      </div>\n    </div>\n\n    <input\n      type="text"\n      placeholder="Current Spend (GBP)"\n      [(ngModel)]="lead.budget"\n      name="budget"\n      [pattern]="onlyNumbersRegEx"\n      #budget="ngModel"\n    />\n    <div class="form-label">Address info</div>\n\n    <input\n      type="text"\n      placeholder="Address line 1*"\n      [(ngModel)]="lead.address1"\n      name="address1"\n      required\n      #address1="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="\n        !(address1.invalid && (address1.dirty || address1.touched || submited))\n      "\n    >\n      <div [hidden]="!address1.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!address1.hasError(\'pattern\')" class="error">\n        Please enter letters only.\n      </div>\n    </div>\n\n    <input\n      type="text"\n      placeholder="Address line 2"\n      [(ngModel)]="lead.address2"\n      name="address2"\n      [pattern]="onlyLettersRegEx"\n      #address2="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="\n        !(address2.invalid && (address2.dirty || address2.touched || submited))\n      "\n    >\n      <div [hidden]="!address2.hasError(\'pattern\')" class="error">\n        Please enter letters only.\n      </div>\n    </div>\n\n    <input\n      type="text"\n      placeholder="Town*"\n      [(ngModel)]="lead.town"\n      name="town"\n      required\n      [pattern]="onlyLettersRegEx"\n      #town="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="!(town.invalid && (town.dirty || town.touched || submited))"\n    >\n      <div [hidden]="!town.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!town.hasError(\'pattern\')" class="error">\n        Please enter letters only.\n      </div>\n    </div>\n\n    <input\n      type="text"\n      placeholder="County*"\n      [(ngModel)]="lead.county"\n      name="country"\n      required\n      [pattern]="onlyLettersRegEx"\n      #country="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="\n        !(country.invalid && (country.dirty || country.touched || submited))\n      "\n    >\n      <div [hidden]="!country.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!country.hasError(\'pattern\')" class="error">\n        Please enter letters only.\n      </div>\n    </div>\n\n    <input\n      type="text"\n      placeholder="Postcode*"\n      [(ngModel)]="lead.post_code"\n      name="postcode"\n      required\n      [pattern]="postcodeRegEx"\n      #postcode="ngModel"\n    />\n    <div\n      role="alert"\n      [hidden]="\n        !(postcode.invalid && (postcode.dirty || postcode.touched || submited))\n      "\n    >\n      <div [hidden]="!postcode.hasError(\'required\')" class="error">\n        Please enter a value.\n      </div>\n      <div [hidden]="!postcode.hasError(\'pattern\')" class="error">\n        Please enter a valid UK postcode.\n      </div>\n    </div>\n\n    <div class="form-label">Additional info</div>\n\n    <div *ngFor="let question of additional">\n      <div class="question">\n        <div class="question">\n          {{ question.question }}\n        </div>\n\n        <select>\n          <option *ngFor="let answer of question.additional">{{\n            answer\n          }}</option>\n        </select>\n      </div>\n    </div>\n\n    <button\n      class="submit-button"\n      type="submit"\n      ng-disabled="!connection.online"\n    >\n      Add Referral\n    </button>\n  </form>\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/referralDetails/referralDetails.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_3__services_globalstorage_globalstorage__["a" /* GlobalStorage */],
        __WEBPACK_IMPORTED_MODULE_6__angular_http__["b" /* Http */],
...
LeadThanksPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-lead-thanks',template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/pages/leadThanks/leadThanks.html"*/'<ion-header>\n  <ion-navbar>\n    <div class="ion-title">Thank you</div>\n    <button ion-button icon-only menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div class="header1">Thank you</div>\n  <div class="header2">\n    Your referral has been added, and will take up to\n    <span class="green">24 hours</span> to be processed\n  </div>\n  <div class="header3">\n    Once a referral has been successfully converted, we will issue you with your\n    referral fee\n  </div>\n\n  <div class="bottom">\n    <a class="transparent-rounded-button small" (click)="goToDashboard()">\n      Back to Dashboard\n    </a>\n    <a class="transparent-rounded-button small" (click)="goToReferralsPage()">\n      Track Referrals\n    </a>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/pages/leadThanks/leadThanks.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavController */]])
], LeadThanksPage);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"/Volumes/RS/rs-ifa/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Volumes/RS/rs-ifa/src/app/app.html"*/
    }),
